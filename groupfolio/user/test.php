...
// Default image path if no profile image exists
$imagePath = isset($profile['profile_image']) ? '../uploads/profile_pictures/' . $profile['profile_image'] : '../assets/default-profile.jpg';
...
<body class="d-flex h-100 text-center text-white bg-dark">
    ...
    <script>
        document.getElementById('profile_image').addEventListener('change', function() {
            ...
            fetch('../upload/upload_image.php', { // Assuming the upload PHP is in this path
                    method: 'POST',
                    body: formData
                })
