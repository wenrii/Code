...
$admin = $about->staff($userId);
$staffData = $about->getStaff();
        ...
        <main>
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="staff.php" class="nav-link active" aria-current="page">
                            <svg class="bi me-2" width="16" height="16">
                    ...
                    <?php foreach ($staffData as $staff) : ?>
                        <div class="col"> <!-- Keep the col div inside the loop -->
                            <div class="card shadow-sm">
                                <?php
                                $status = $staff['is_admin'] == 1 ? 'Admin' : 'User';
                                $id = $staff['user_id'];
                                ?>
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="update_is_admin.php?user_id=<?= $staff['user_id'] ?>&current_is_admin=<?= $staff['is_admin'] ?>">
                                                <button type="button" class="btn btn-sm btn-outline-secondary">
                                                    <?= $staff['is_admin'] == 1 ? 'Demote' : 'Promote' ?>
                                                </button>
                                            </a>
                                        </div>
                                    </div>
