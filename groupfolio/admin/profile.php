...
$profile = $objProfile->profile($_GET['personal_id']);
                    ...
                    <div class="card-body">
                        ...
                        <div class="profile-info mt-4">
                            ...
                            <div class="row">
                                ...
                                <hr class="my-4">
                                <a href="edit.php?personal_id=<?= htmlspecialchars($profile['personal_id']) ?>" class="w-100 btn btn-primary btn-lg my-3">Edit</a>
                            </div>
                        </div>
                    </div>
                </div>
