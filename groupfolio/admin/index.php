        ...
        <main>
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="staff.php" class="nav-link link-dark">
                            <svg class="bi me-2" width="16" height="16">
                ...
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?php echo $imagePath; ?>" alt="" width="32" height="32" class="rounded-circle me-2">
            ...
            <div class="container-fluid p-4">
                <h2>Recent Updates:</h2><br><br>
                <h4>feature added (0.2):</h4>
                <p>New feature added to the Admin UI, allowing Admins to view their users. This feature will help in monitoring and managing user activities.</p>
                <br>
                <h4>bug fixed (0.1):</h4>
                <p>Issue about the profile in view page not aligning properly is now fixed, making it much more clean and responsive.</p>
